export const portfolioStyles = {
  section:
    "scroll-mt-24 px-2 pt-4 pb-12 sm:px-4 md:px-10 md:pt-6 md:pb-20 bg-gradient-to-b from-slate-50/60 via-white to-slate-50/40 dark:from-slate-950/80 dark:via-slate-900 dark:to-slate-950/80",
